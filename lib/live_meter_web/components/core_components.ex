defmodule LiveMeterWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    >
      <div class={[
        "flex items-start gap-3 w-80 sm:w-96 max-w-80 sm:max-w-96 text-wrap rounded-lg border p-4 text-sm shadow-lg",
        @kind == :info &&
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveMeterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveMeterWeb.Gettext, "errors", msg, opts)
    end
  end
